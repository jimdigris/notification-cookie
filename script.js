(function () {
    ...
    if (!notification_cookie) {
        ...
        let max_age = 60;                                                                           // время жизни куки

        // тело уведомления
        let notification = `<div class="${class_notification_body}"><p class="${class_notification_txt}">Сайт использует куки. Продолжая им пользоваться, вы соглашаетесь на обработку данных в соответствии с: <a class="${class_notification_link}" href="#">Политикой обработки персональных данных</a> и <a class="${class_notification_link}" href="#">Согласием на обработку персональных данных</a>.</p> <button class="${class_notification_btn}">OK</button></div>`;
